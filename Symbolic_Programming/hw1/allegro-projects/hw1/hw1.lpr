;; -*- lisp-version: "9.0 [Windows] (Jan 10, 2014 23:51)"; cg: "9.0"; -*-

(in-package :cg-user)

(define-project :name :hw1
  :modules (list (make-instance 'module :name "points-per-quarter.lisp")
                 (make-instance 'module :name "points-per-quarter-extra-credit.lisp"))
  :projects nil
  :libraries nil
  :editable-files nil
